#!/usr/bin/env python
# rename to telos.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/telos/")
...
print("telos $" + str(usd) + " | iconName=invest-applet")
print("---")
